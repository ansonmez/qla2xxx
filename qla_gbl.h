...
// edif rx update/delete list management functions
...
// edif sa_index free pool functions
...
bool qla2xxx_throttle_req(struct qla_hw_data *ha, fc_port_t *fcport);
...
void qla2xxx_scmr_manage_qdepth(struct fc_port *fcport, bool inc);
void qla2xxx_update_sfc_ios(struct qla_hw_data *ha, fc_port_t *fcport, int new);
...
ssize_t qla2x00_edif_doorbellr(struct device *, struct device_attribute *,
    char *);
void ql_print_bsg_sglist(uint , scsi_qla_host_t *, uint , char *,
    void *);
